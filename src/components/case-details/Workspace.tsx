...
import { Search, Sparkles, Send, Plus, ListChecks, StickyNote, CalendarCheck, Wand2, Package, FolderKanban, ExternalLink, FolderOpen, Megaphone } from 'lucide-react';
