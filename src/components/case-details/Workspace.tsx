...
import { Search, Sparkles, Send, Plus, ListChecks, StickyNote, CalendarCheck, Wand2, Package, FolderKanban, ExternalLink, FolderOpen, FileCheck2 } from 'lucide-react';
...
const TOOL_ICONS: Record<CaseToolKind, React.ElementType> = {
  ...
  'reference-letter-validator': FileCheck2,
};
