          ...
          {stage === 'error' && (
            <div className="py-6 text-center">
              ...
              <p className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">
                Could not read passport automatically
              </p>
              ...
              {result?.rawText && (
                <details className="text-left mb-4">
                  <summary className="text-xs text-gray-400 cursor-pointer hover:text-gray-600 dark:hover:text-slate-300">
                    Show raw OCR text
                  </summary>
                  <pre className="mt-2 text-xs bg-gray-50 dark:bg-slate-800 p-3 rounded-lg overflow-auto max-h-32 text-gray-600 dark:text-slate-400 whitespace-pre-wrap">
                    {result.rawText}
                  </pre>
                </details>
              )}
