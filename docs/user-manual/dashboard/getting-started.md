...
The board shows tasks for the current working week (Monday–Friday), grouped by day. Use the scope
tabs to change whose tasks you see:

- **My Tasks** — only tasks assigned to you.
- **Team** — tasks assigned to your team.
- **All** — every task across the firm/agency.

Use the week navigation to move to a previous or following week.
